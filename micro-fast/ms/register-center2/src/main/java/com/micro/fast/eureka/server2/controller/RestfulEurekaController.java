package com.micro.fast.eureka.server2.controller;
...
public class RestfulEurekaController {
    ...
    private void populateApps(Map<String, Object> model) {
        ...
        for (Application app : sortedApplications) {
            ...
            for (Iterator<Map.Entry<InstanceStatus, List<Pair<String, String>>>> iter = instancesByStatus
                    .entrySet().iterator(); iter.hasNext(); ) {
                Map.Entry<InstanceStatus, List<Pair<String, String>>> entry = iter
                        .next();
