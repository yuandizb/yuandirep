package com.micro.fast.ssm.sharding.service.impl;
...
import com.micro.fast.ssm.sharding.service.SsmService;
import com.micro.fast.ssm.sharding.dao.SsmMapper;
...
public  class SsmServiceImpl<T, ID extends Serializable, MAPPER extends SsmMapper<T,ID>> implements SsmService<T,ID> {
    ...
    @Override
    public  ServerResponse getByCondition(T pojo,int pageSize,int pageNum,String orderBy){
        // 判断是否排序
